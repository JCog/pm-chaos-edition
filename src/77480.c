...
void appendGfx_player(void* data) {
    ...
    if (playerStatus->actionState == ACTION_STATE_SLIDING) {
        ...
        guRotateF(sp20, clamp_angle(chaosStatus.playerPitch), 0.0f, 0.0f, 1.0f);
        guMtxCatF(spE0, sp20, sp20);
        guRotateF(spA0, clamp_angle(playerStatus->spriteFacingAngle + chaosStatus.playerSpriteAngle), 0.0f, 1.0f, 0.0f);
        ...
        guRotateF(sp20, clamp_angle(playerStatus->pitch + chaosStatus.playerPitch), 0.0f, 0.0f, 1.0f);
...
void appendGfx_player_spin(void* data) {
    ...
    for (i = 0; i < 2; i++) {
        ...
        if (i == 0) {
            ...
            guRotateF(rotation, clamp_angle(yaw + chaosStatus.playerSpriteAngle), 0.0f, -1.0f, 0.0f);
            guRotateF(mtx, clamp_angle(playerStatus->pitch + chaosStatus.playerPitch), 0.0f, 0.0f, 1.0f);
